...
class _RecordExerciseView extends State<RecordExerciseView> {
  ...
  Future<void> _selectDate(BuildContext context) async {
    final DateTime? picked = await showDatePicker(context: context, initialDate: _dateTime, firstDate: DateTime(2015), lastDate: DateTime(2101));
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ElevatedButton(
                          onPressed: () {
                            BlocProvider.of<MockApiBloc>(context).add(PostRecordExerciseApi(type, selectedDateTime, _messageController.text));
                          },
                          child: const Text('등록'),
                        ),
                      ],
